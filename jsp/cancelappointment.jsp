...
<div class="notice" id="notice">
      <h4>
        <p style="font-weight: 400; text-align: center; padding-left: 70px; padding-right: 70px; padding-top: 6px;">Press OK to cancel your appointment</p>
      </h4>
    </div>
	<br>
	<table align="center">
    
<form id="tt" method="post" action = "cancelbooking">
    
<tbody>

<tr>
<td>
<input type=button onclick="washtt()" id="wash" value="submit"/>
</td>
</tr>
